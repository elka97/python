...
#https://www.coursera.org/learn/vvedenie-mashinnoe-obuchenie/supplement/WQ8xO/rabota-s-viektorami-i-matritsami-v-numpy
...
my_list = np.random.normal(loc=1, scale=10, size=(1000, 50))
#print(my_list)

#Код для самопроверки X = np.random.normal(loc=1, scale=10, size=(1000, 50)) print X

# 2. Nормировка матрицы
...
#print(np.mean.__doc__) vmesto googla ))
means = np.mean(my_list, axis=0)
std = np.std(my_list, axis=0)
norm_list = ((my_list - means)/std)
#print(means)
#print(std)
#print(norm_list)
...
Z = np.array([[4, 5, 0],
             ...
             [9, 9, 9],
             [4, 7, 1]])
z_new = np.sum(Z, axis=1)
#print (np.nonzero(z_new>10))
